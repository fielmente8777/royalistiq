  ...
  return (
    <>
      {href === "#form" ? (
        <button
          onClick={handleClick}
          className={`flex items-center uppercase gap-2 shadow-md border w-fit px-4 py-2 hover:scale-95 transition-all duration-300 ease-in-out hover:scale-x-105 active:scale-95 ${className}`}
          {...props}
        >
          {whatsAppIcon && (
            <span>
        ...
        <Link
          ...
          target="_blank"
          rel="noreferrer"
          className={`flex uppercase items-center tracking-widest gap-1 border w-fit px-4 py-2 hover:scale-95 transition-all duration-300 ease-in-out hover:scale-x-105 active:scale-95 ${className}`}
          {...props}
        >
